...
export interface CrossRoadRoute {
...
export interface CrossRoadObject {
     ...
     */
    addRoute(pattern: any, handler?: Function, priority?: number): CrossRoadRoute;
     ...
     */
    removeRoute(route: CrossRoadRoute): void;
    ...
    /**
     * Signal dispatched every time that crossroads.parse can't find a Route that matches the request. Useful for debugging and error handling.
     */
    bypassed: signal.Signal;

    /**
     * Signal dispatched every time that crossroads.parse find a Route that matches the request. Useful for debugging and for executing tasks that should happen at each routing.
     */
     ...
     */
    pipe(router: CrossRoadObject): void;

    /**
     * "Ceci n'est pas une pipe"
     */
    unpipe(router: CrossRoadObject): void;
}